...
class ForumDetails extends StatefulWidget {
  final String uid;
  final DocumentSnapshot threadDetails;
  final DocumentSnapshot userDetails;

  ForumDetails({this.uid, this.threadDetails, this.userDetails});

  @override
  _ForumDetails createState() => _ForumDetails(
      uid: uid, threadDetails: threadDetails, userDetails: userDetails);
}
...
class _ForumDetails extends State<ForumDetails> {
  ...
  _ForumDetails({this.uid, this.threadDetails, this.userDetails});
  @override
